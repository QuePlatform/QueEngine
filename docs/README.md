...
- **[API Reference](./API.md):** Explore the public functions available in the engine.
- **[Data Structures](./TYPES.md):** Understand the configuration and result types used by the API.